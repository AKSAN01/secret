export const memories = [
  {
    id: 1,
    imageUrl: "/Geralflores.jpg", 
    date: "Nuestro primer Fin de año",
    message: "No sabes la emocion que senti al vivir todo eso contigo, para mi fue algo magico y unico, que mi familia conociera a alguien tan especial, tan unica y maravillosa es algo que no puedo explicar, verte tan hermosa y como acoplabas tan bien en mi familia fue algo especial "
  },
  {
    id: 2,
    imageUrl: "/Primerviaje.jpg",
    date: "Nuestro Primer Viaje",
    message: "Uno de los momentos mas increibles de nuestra relacion, algo que recuerdo con amor, nostalgia y calidez, viajar, dormir a tu lado, conocer a tu familia, mostrarme algo tan intimo, son sensaciones que quedaron tatuadas a fuego en mi alma y me mostro lo especial que me haces sentir"
  },
